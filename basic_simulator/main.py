...
from containers.managers.action_resolver import MovementResolverContainer, MeleeAttackResolverContainer, MoveManeuverResolverContainer, MoveAttackManeuverResolverContainer
...
class GurpsMain(ShowBase, FSM.FSM):
    ...
    def step_complete(self):
        ...
        first_failed, first_unready = None, None
        ...
        for action in unresolved_actions:
            if action.status == ActionStatus.PARTIAL_UNREADY or \
                ...
                # TODO: after resolving the action, handle any events generated by the results of the resolution.
